(function ($, Drupal) {
  ...
  Drupal.behaviors.header = {
    attach: function (context) {
      var timer; // Open Header Dropdown Menu.
      ...
      function openMenu(t) {
        ...
        tMenu.addClass('active'); // Close other dropdown menus.
      ...
      $('.header__menu-item--expanded', context).on('mouseover focusin', function (e) {
        clearTimeout(timer);
      ...
      $('.header__menu-link--toggle', context).on('click', function (e) {
        ...
        var menus = menuItems.children('.header__menu-items--mobile'); // Display submenu.
